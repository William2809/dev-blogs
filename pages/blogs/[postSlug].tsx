...
export const getStaticPaths: GetStaticPaths = () => {
    ...
    // blocking => this will first see the slug and it will try to get data from static pages and if there is a page it will first hang the browser and try to generate new page.
